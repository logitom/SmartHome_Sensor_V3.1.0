...
This sample application configures a node to periodically receive a message from a sender.
...
On the STM32 Nucleo board this sample application for Udp-receiver must be running.
Another STM32 Nucleo board with its X-NUCLEO-IDS01A4 or X-NUCLEO-IDS01A5 or X-NUCLEO-S2868A1 or X-NUCLEO-S2915A1 STM32 expansion board (running the Udp-sender sample application included in this package) should be used to test the communication via UDP over 6LoWPAN.
