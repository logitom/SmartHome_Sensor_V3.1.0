...
/**
* @brief  MSP Initialization of Timer.
* @param  None
* @retval None
*/
...
/**
* @brief  RESET's the timer after n number of Overflow.
* @param  number of overflow after the reset is to be done
* @retval None
*/
